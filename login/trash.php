    ...
    if (empty($error)) {
        if (in_array($profile_ext, $allowedTypes) && in_array($cv_ext, $allowedCv)) {
            if (move_uploaded_file($profile_temp, $profile_targetPath) && move_uploaded_file($cv_temp, $cv_targetPath)) {
                // Insert new tutor data into the database with the hashed password
                $insert = "INSERT INTO tutor (Fname, email, address, contact, experience, profile_pic, cv, tutoring_days, tutoring_levels, tutoring_courses, availability, pass) 
                    VALUES ('$Fname', '$email', '$address', '$contact', $experience, '$profile_pic', '$cv', '$tutoring_days', '$tutoring_levels', '$tutoring_courses', '$availability', '$hashed_pass')";
    ...
    <div class="container">
        <div class="signup form">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <br>
                <label class="file-upload" for="Cv">
